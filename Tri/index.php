...
<body>
    ...
    <div id="container">
        ...
        <main>
            ...
            <?php if(get_option('tri_alert_enabled')=='on'){ ?>
                <div class="teleport-marker alert"></div>
                <section id="alert" class="content-box listing-item home-listing-item" role="alert" data-sidebar>
            ...
            <?php } ?>
            <section id="hero" class="content-box listing-item home-listing-item">
            </section><!--/hero-->
        </main>
    </div><!--/container-->
</body>
